class InitDb < ActiveRecord::Migration
  def change
    ...
    add_index "banners", ["record_label_id"], :name => "index_banners_on_record_label_id"
    ...
    add_index "genres", ["cached_slug"], :name => "index_categories_on_cached_slug", :unique => true
    ...
    add_index "pictures", ["picture_file_name"], :name => "index_pictures_on_picture_file_name"
    ...
    add_index "purchase_items", ["song_id"], :name => "index_purchase_items_on_song_id"
    ...
    add_index "record_labels", ["cached_slug"], :name => "index_record_labels_on_cached_slug", :unique => true
    ...
    add_index "song_nonces", ["nonce"], :name => "index_song_nonces_on_nonce"
    add_index "song_nonces", ["session_id"], :name => "index_song_nonces_on_session_id"
    add_index "song_nonces", ["song_id"], :name => "index_song_nonces_on_song_id"
    ...
    add_index "songs", ["cached_slug"], :name => "index_songs_on_cached_slug", :unique => true
    add_index "songs", ["created_at"], :name => "index_songs_on_created_at"
    add_index "songs", ["genre_id"], :name => "index_songs_on_category_id"
    add_index "songs", ["remix_of_id"], :name => "index_songs_on_remix_of_id"
